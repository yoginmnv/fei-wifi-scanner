...
public class DBHelper extends SQLiteOpenHelper
{
	...
	public static final String SQL_CREATE_LOCATION_ENTRY = "CREATE TABLE IF NOT EXISTS " + LocationEntry.TABLE_NAME + " (" +
	...
	public static final String SQL_CREATE_WIFI_ENTRY = "CREATE TABLE IF NOT EXISTS " + WifiEntry.TABLE_NAME + " (" +
	...
	public static final String SQL_CREATE_HISTORY_ENTRY = "CREATE TABLE IF NOT EXISTS " + HistoryEntry.TABLE_NAME + " (" +
